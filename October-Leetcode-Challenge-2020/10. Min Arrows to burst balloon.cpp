...
public:
    int findMinArrowShots(vector<vector<int>>& points) {
        ...
        //sort arrows according to their end points
        ...
        for(int i=1;i<len;i++){
            //if end point of current balloon lies beyond the range of max end point of previous balloon then we need a extra arrow
